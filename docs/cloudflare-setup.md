...
| `limits.cpu_ms` | `30000` | Workers **Paid** only. Free CPU is fixed at 10 ms and this key does nothing there. If a Free-plan deploy is rejected for this block, delete it. |
